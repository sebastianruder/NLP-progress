...
| ----------------------------------- | ----- | ----- | --------------- | -------------- |
| KGPOOL (Nadgeri et al., 2021) | 92.3 | 85.4 | [KGPool: Dynamic Knowledge Graph Context Selection for Relation
Extraction](https://arxiv.org/pdf/2106.00459.pdf) | [KGPOOL](https://github.com/nadgeri14/KGPool) |
...
| Model                               | F1    | Paper / Source  | Code           |
| ----------------------------------- | ----- | --------------- | -------------- |
| KGPOOL (Nadgeri et al., 2021)            | **88.60**  | [KGPool: Dynamic Knowledge Graph Context Selection for Relation
Extraction](https://arxiv.org/pdf/2106.00459.pdf) |
