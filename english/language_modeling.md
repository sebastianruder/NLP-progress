...
| Transformer-XL (Dai et al., 2018) ***under review*** | 56.72 | 54.55 | 24M | [Transformer-XL: Language Modeling with Longer-Term Dependency](https://openreview.net/pdf?id=HJePno0cYm) | [Official](https://github.com/kimiyoung/transformer-xl) |
...
| Model           | Validation perplexity | Test perplexity | Number of params | Paper / Source | Code |
| ------------- | :---:| :---:| :---:| -------- | --- |
| Transformer-XL Large (Dai et al., 2018) ***under review*** | 18.2 | 18.9 | 257M | [Transformer-XL: Language Modeling with Longer-Term Dependency](https://openreview.net/pdf?id=HJePno0cYm) | [Official](https://github.com/kimiyoung/transformer-xl) |
...
| ------------- | :-----:| :-----:| --------- | --- |
| Transformer-XL Large (Dai et al., 2018) ***under review*** | 23.5 | 0.46B | [Transformer-XL: Language Modeling with Longer-Term Dependency](https://openreview.net/pdf?id=HJePno0cYm) | [Official](https://github.com/kimiyoung/transformer-xl) |
