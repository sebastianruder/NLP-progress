...
| ------------------------------------------------------------ | :----------------------------------------------------------: | ------------------------------------------------------------ | ----------- |
| 5-layer convolutional network (Krizhevsky et al., 2012), Word2Vec | 75.0% (multimodal, Mohammad dataset), 79.0% (multimodal, Tsvetkov dataset) | [Shutova et. al, 2016](http://www.aclweb.org/anthology/N16-1020) | Unavailable |
