...
| ------------- | :-----:| :-----:| --- |
| Zhou et al. (2016) (POS, DEP, NER, SRL)* | 0.71 | 0.66 | [AMR Parsing with an Incremental Joint Model](https://aclweb.org/anthology/D16-1065) |
| Wang et al. (2015) (POS, DEP, NER, SRL)* | 0.70 | 0.66 | [Boosting Transition-based AMR Parsing with Refined Actions and Auxiliary Analyzers](http://www.aclweb.org/anthology/P15-2141) |
| Stack-LSTM (Ballesteros and Al-Onaizan, 2017) (POS, DEP) | 0.69 | 0.64  | [AMR Parsing using Stack-LSTMs](http://www.aclweb.org/anthology/D17-1130) |
...
| ------------- | :-----:| --- |
Ours | 73.7 | [AMR Parsing as Graph Prediction with Latent Alignment](https://arxiv.org/abs/1805.05286) |
...
| Model           | Smatch  |  Paper / Source |
| ------------- | :-----:| --- |
Ours | 74.4 | [AMR Parsing as Graph Prediction with Latent Alignment](https://arxiv.org/abs/1805.05286) |
